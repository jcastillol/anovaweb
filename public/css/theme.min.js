...
this.activeTarget=e,this.clear();var i=this.selector+'[data-target="'+e+'"],'+this.selector+'[href="'+e+'"]',o=t(i).parents("li").addClass("active");o.parent(".dropdown-menu").length&&(o=o.closest("li.dropdown").addClass("active")),o.trigger("activate.bs.scrollspy")},e.prototype.clear=function(){t(this.selector).parentsUntil(this.options.target,".active").removeClass("active")};var o=t.fn.scrollspy;t.fn.scrollspy=i,t.fn.scrollspy.Constructor=e,t.fn.scrollspy.noConflict=function(){return t.fn.scrollspy=o,this},t(window).on("load.bs.scrollspy.data-api",function(){t('[data-spy="scroll"]').each(function(){var e=t(this);i.call(e,e.data())})})}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var o=t(this),n=o.data("bs.tab");n||o.data("bs.tab",n=new i(this)),"string"==typeof e&&n[e]()})}var i=function(e){this.element=t(e)};i.VERSION="3.3.7",i.TRANSITION_DURATION=150,i.prototype.show=function(){var e=this.element,i=e.closest("ul:not(.dropdown-menu)"),o=e.data("target");if(o||(o=e.attr("href"),o=o&&o.replace(/.*(?=#[^\s]*$)/,"")),!e.parent("li").hasClass("active")){var n=i.find(".active:last a"),s=t.Event("hide.bs.tab",{relatedTarget:e[0]}),a=t.Event("show.bs.tab",{relatedTarget:n[0]});if(n.trigger(s),e.trigger(a),!a.isDefaultPrevented()&&!s.isDefaultPrevented()){var r=t(o);this.activate(e.closest("li"),i),this.activate(r,r.parent(),function(){n.trigger({type:"hidden.bs.tab",relatedTarget:e[0]}),e.trigger({type:"shown.bs.tab",relatedTarget:n[0]})})}}},i.prototype.activate=function(e,o,n){function s(){a.removeClass("active").find("> .dropdown-menu > .active").removeClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!1),e.addClass("active").find('[data-toggle="tab"]').attr("aria-expanded",!0),r?(e[0].offsetWidth,e.addClass("in")):e.removeClass("fade"),e.parent(".dropdown-menu").length&&e.closest("li.dropdown").addClass("active").end().find('[data-toggle="tab"]').attr("aria-expanded",!0),n&&n()}var a=o.find("> .active"),r=n&&t.support.transition&&(a.length&&a.hasClass("fade")||!!o.find("> .fade").length);a.length&&r?a.one("bsTransitionEnd",s).emulateTransitionEnd(i.TRANSITION_DURATION):s(),a.removeClass("in")};var o=t.fn.tab;t.fn.tab=e,t.fn.tab.Constructor=i,t.fn.tab.noConflict=function(){return t.fn.tab=o,this};var n=function(i){i.preventDefault(),e.call(t(this),"show")};t(document).on("click.bs.tab.data-api",'[data-toggle="tab"]',n).on("click.bs.tab.data-api",'[data-toggle="pill"]',n)}(jQuery),+function(t){"use strict";function e(e){return this.each(function(){var o=t(this),n=o.data("bs.affix"),s="object"==typeof e&&e;n||o.data("bs.affix",n=new i(this,s)),"string"==typeof e&&n[e]()})}var i=function(e,o){this.options=t.extend({},i.DEFAULTS,o),this.$target=t(this.options.target).on("scroll.bs.affix.data-api",t.proxy(this.checkPosition,this)).on("click.bs.affix.data-api",t.proxy(this.checkPositionWithEventLoop,this)),this.$element=t(e),this.affixed=null,this.unpin=null,this.pinnedOffset=null,this.checkPosition()};i.VERSION="3.3.7",i.RESET="affix affix-top affix-bottom",i.DEFAULTS={offset:0,target:window},i.prototype.getState=function(t,e,i,o){var n=this.$target.scrollTop(),s=this.$element.offset(),a=this.$target.height();if(null!=i&&"top"==this.affixed)return n<i&&"top";if("bottom"==this.affixed)return null!=i?!(n+this.unpin<=s.top)&&"bottom":!(n+a<=t-o)&&"bottom";var r=null==this.affixed,l=r?n:s.top,h=r?a:e;return null!=i&&n<=i?"top":null!=o&&l+h>=t-o&&"bottom"},i.prototype.getPinnedOffset=function(){if(this.pinnedOffset)return this.pinnedOffset;this.$element.removeClass(i.RESET).addClass("affix");var t=this.$target.scrollTop(),e=this.$element.offset();return this.pinnedOffset=e.top-t},i.prototype.checkPositionWithEventLoop=function(){setTimeout(t.proxy(this.checkPosition,this),1)},i.prototype.checkPosition=function(){if(this.$element.is(":visible")){var e=this.$element.height(),o=this.options.offset,n=o.top,s=o.bottom,a=Math.max(t(document).height(),t(document.body).height());"object"!=typeof o&&(s=n=o),"function"==typeof n&&(n=o.top(this.$element)),"function"==typeof s&&(s=o.bottom(this.$element));var r=this.getState(a,e,n,s);if(this.affixed!=r){null!=this.unpin&&this.$element.css("top","");var l="affix"+(r?"-"+r:""),h=t.Event(l+".bs.affix");if(this.$element.trigger(h),h.isDefaultPrevented())return;this.affixed=r,this.unpin="bottom"==r?this.getPinnedOffset():null,this.$element.removeClass(i.RESET).addClass(l).trigger(l.replace("affix","affixed")+".bs.affix")}"bottom"==r&&this.$element.offset({top:a-e-s})}};var o=t.fn.affix;t.fn.affix=e,t.fn.affix.Constructor=i,t.fn.affix.noConflict=function(){return t.fn.affix=o,this},t(window).on("load",function(){t('[data-spy="affix"]').each(function(){var i=t(this),o=i.data();o.offset=o.offset||{},null!=o.offsetBottom&&(o.offset.bottom=o.offsetBottom),null!=o.offsetTop&&(o.offset.top=o.offsetTop),e.call(i,o)})})}(jQuery),$(function(){navbar.initialize(),settings.initialize(),pricing_charts.initialize(),global_notifications.initialize(),ecommerce.initialize(),retina.initialize(),zoomerang.initialize()});var settings={initialize:function(){var t=$("#settings-module"),e=$("#open-settings",t),i=$("[data-option='navbar']",t),o=$("nav.navbar"),n=$("body, html");e.click(function(e){e.preventDefault(),t.toggleClass("opened")}),i.click(function(t){t.preventDefault();var e=$(this).data("class");o.removeClass("navbar-default navbar-transparent navbar-inverse").addClass(e),"navbar-default"===e?o.find(".navbar-brand img").attr("src","images/logo-alt-b.png"):o.find(".navbar-brand img").attr("src","images/logo-alt-w.png")}),n.click(function(){t.removeClass("opened")}),t.click(function(t){t.stopPropagation()}),t.length&&((new Image).src="images/logo-alt-w.png",(new Image).src="images/logo-alt-b.png")}},zoomerang={initialize:function(){Zoomerang.config({maxHeight:730,maxWidth:900}).listen('[data-trigger="zoomerang"]')}},ecommerce={initialize:function(){this.displayCart(),this.search()},displayCart:function(){var t,e=$(".store-navbar .cart"),i=$("#cart-modal"),o=function(){i.addClass("visible"),clearTimeout(t),t=null},n=function(){t=setTimeout(function(){i.removeClass("visible")},400)};e.hover(o,n),i.hover(o,n)},search:function(){var t=$(".store-navbar .search-field"),e=t.find(".input-search");e.focus(function(){t.addClass("focus")}),e.blur(function(){t.removeClass("focus")})}},navbar={initialize:function(){this.themeSites(),window.utils.isMobile()||this.dropdowns()},dropdowns:function(){var t=$(".navbar-nav li.dropdown");t.each(function(t,e){var i=$(this);i.hover(function(){i.addClass("open")},function(){i.removeClass("open")})})},themeSites:function(){var t=$("[data-toggle-header-sections-menu]"),e=$("#header-sections-menu"),i=$("body");t.click(function(o){if(o.preventDefault(),i.toggleClass("header-panel-visible"),i.hasClass("header-panel-visible")){t.find("i").removeClass("ion-plus").addClass("ion-minus");var n=t.closest(".navbar");if(n.hasClass("navbar-transparent"))return void e.removeClass("fixed");n.hasClass("navbar-fixed-top")&&e.addClass("fixed")}else t.find("i").removeClass("ion-minus").addClass("ion-plus")})}},global_notifications={initialize:function(){setTimeout(function(){$(".global-notification").removeClass("uber-notification").addClass("uber-notification-remove")},5e3)}},pricing_charts={initialize:function(){var t=$(".pricing-charts-tabs .tab"),e=$(".pricing-charts .chart header .price");t.click(function(){t.removeClass("active"),$(this).addClass("active");var i=$(this).data("tab"),o=e.filter(":not(."+i+")");o.addClass("go-out"),e.filter("."+i).addClass("active"),setTimeout(function(){o.removeClass("go-out").removeClass("active")},250)})}},retina={initialize:function(){window.devicePixelRatio>=1.2&&$("[data-2x]").each(function(){"IMG"==this.tagName?$(this).attr("src",$(this).attr("data-2x")):$(this).css({"background-image":"url("+$(this).attr("data-2x")+")"})})}};window.utils={isFirefox:function(){return navigator.userAgent.toLowerCase().indexOf("firefox")>-1},debounce:function(t,e,i){var o;return function(){var n=this,s=arguments,a=function(){o=null,i||t.apply(n,s)},r=i&&!o;clearTimeout(o),o=setTimeout(a,e),r&&t.apply(n,s)}},isMobile:function(){return window.innerWidth<=1024},parallax_text:function(t,e){e="undefined"!=typeof e?e:0,$(window).scroll(function(){var i,o=$(window).scrollTop(),n=o/1.4,s=e+n+"px";"transform"in document.body.style?"transform":"-webkit-transform";i=o>0?(1e3-2.7*o)/1e3:1,t.css({position:"relative",top:s,opacity:i})})}},$(function(){$(".expand").on("click",function(){$expand=$(this).find(">:first-child"),"+"==$expand.text()?$expand.text("-"):$expand.text("+")})});
